...
const App = () => {
  ...
  const switchTooltipText = ['Using external account', 'Using internal account'];
        ...
        <div className='navbar is-dark is-fixed-top'>
          <div className='container is-align-items-center is-flex is-flex-direction-row is-max-widescreen'>
            ...
            <div 
              ...
              <input id='switch' className='switch is-medium' type='checkbox' onChange={handleSwitchChange}/>
